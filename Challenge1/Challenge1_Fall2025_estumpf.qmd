...
2.  **Data Description: Please use the necessary commands and codes, and briefly describe this data with a short writing paragraph answering the following questions.**
    ...
    athleteEventsDim <- dim(athleteEvents)
    print(sprintf(
        'Rows Count: %s', 
        athleteEventsDim[1]
    ))
...
3.  **Data Transformation: use necessary commands and codes and answer the following questions.**
    ...
    print("*** Question 1 Output ***")
    getUniqueCountForCol <- function(df, column) {
      count(distinct(df[column]))
    }
    print(sprintf(
      'Unique Sports: %s',
      getUniqueCountForCol(athleteEvents, "Sport")
    ))
    print(sprintf(
      'Unique Teams: %s',
      getUniqueCountForCol(athleteEvents, "Team")
    ))
    print(sprintf(
      'Unique Names: %s',
      getUniqueCountForCol(athleteEvents, "Name")
    ))
