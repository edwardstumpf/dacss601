...
-   **Data Description: Please use the necessary commands and codes, and briefly describe this data with a short writing paragraph answering the following questions.**
    ...
    print(sprintf(
        'Year Range: %s - %s', 
        min(athleteEvents['Year']),
        max(athleteEvents['Year'])
    ))

    # Question 4
    print("*** Question 4 Output ***")
    # Helper function to output column names with their NA value count
    outputNaColumns <- function (df) {
      dfColumns <- colnames(df)
      for (index in seq_along(df)) {
        naCount <- sum(is.na(df[index]))
        if (naCount > 0) {
          columnName <- dfColumns[index]
          print(sprintf(
...
2.  **Data Description: Please use the necessary commands and codes and briefly describe this data with a short writing paragraph answering the following questions.**
    ...
    # Question 3
    print("*** Question 3 Output ***")
    outputNaColumns(paintings) # Helper function from Part 1.1
    ```
...
3.  **Data Transformation: use necessary commands and codes, and answer the following questions.**
    ...
    # Question 1
    print("*** Question 1 Output ***")
    printUniqueCountForCol(paintings, "museum") # Helper function from Part 1
...
2.  **Data Description: Please use the necessary commands and codes and briefly describe this data with a short writing paragraph answering the following questions.**
    ...
    print("")
    print("*** Question 3 Output ***")
    outputNaColumns(babyNames) # Helper function from Part 1.1
    ```
